...
#ifndef RAVL_GENETIC_GPInstSubtract_HH
#define RAVL_GENETIC_GPInstSubtract_HH 1
...
namespace RavlN { namespace GeneticN {
  ...
  public:
    //! Factory constructor
    GPInstSubtractC(const GeneFactoryC &factory)
    {
    ...
    static GeneTypeC::RefT &GeneType() {
      static GeneTypeC::RefT x = new GeneTypeClassShareC(typeid(typename GPInstSubtractC<DataT>::RefT));
      return x;
    }
    ...
    typedef RavlN::SmartPtrC<GPInstSubtractC<DataT> > RefT;
