...
#ifndef RAVL_GENETIC_GPInstMultiply_HH
#define RAVL_GENETIC_GPInstMultiply_HH 1
...
namespace RavlN { namespace GeneticN {
  ...
  class GPInstMultiplyC
   : public GPInstructionC
  {
  public:
    //! Factory constructor
    GPInstMultiplyC(const GeneFactoryC &factory)
    {
    ...
    static GeneTypeC::RefT &GeneType() {
      static GeneTypeC::RefT x = new GeneTypeClassC(typeid(typename GPInstMultiplyC<DataT>::RefT));
      return x;
    }
    ...
    typedef RavlN::SmartPtrC<GPInstMultiplyC<DataT> > RefT;
