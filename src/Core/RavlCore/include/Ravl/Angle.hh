...
namespace RavlN {
  ...
  public:
    ...
    [[nodiscard]] inline RealT Diff(const AngleC &val) const;
    ...
    [[nodiscard]] inline RealT Sin() const { return RavlN::Sin(angle); }
    //: Get sin of angle.
    
    [[nodiscard]] inline RealT Cos() const { return RavlN::Cos(angle); }
    //: Get cos of angle.
