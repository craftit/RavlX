...
#ifndef RAVL_ARRAY2ITER7_HEADER
#define RAVL_ARRAY2ITER7_HEADER 1
//////////////////////////////////////////////////////
//! rcsid="$Id$"
//! docentry="Ravl.API.Core.Arrays.2D"
//! file="Ravl/Core/Container/Array/Array2dIter7.hh"
//! lib=RavlCore
...
#include "Ravl/BfAcc2Iter7.hh"

namespace RavlN {
  //! userlevel=Normal
  //: Array2dC iterator for 7 arrays.
  // This will iterate through seven rectangles.  The rectangles need not
  ...
  class Array2dIter7C 
    : public BufferAccess2dIter7C<Data1T,Data2T,Data3T,Data4T,Data5T,Data6T,Data7T>
  {
  public:
    Array2dIter7C()
    {}
    ...
    Array2dIter7C(const Array2dC<Data1T> &arr1,
		  ...
		  const Array2dC<Data7T> &arr7,
		  bool matching = true)
      : BufferAccess2dIter7C<Data1T,Data2T,Data3T,Data4T,Data5T,Data6T,Data7T>(arr1,arr1.Range2(),
									       arr2,arr2.Range2(),
									       arr3,arr3.Range2(),
									       arr4,arr4.Range2(),
									       arr5,arr5.Range2(),
	...
	RavlAssertMsg(dat1.Range().Rows() <= dat7.Range().Rows(),"Array2dIter3C, Seventh array is has fewer rows than the first. ");
	RavlAssertMsg(dat1.Range().Cols() <= dat7.Range().Cols(),"Array2dIter3C, Seventh array is has fewer cols than the first. ");
      }
      First();
    }
    ...
    Array2dIter7C(const Array2dC<Data1T> &arr1,
      ...
      : dat1(arr1,rect),
        ...
        dat6(arr6,rect),
        dat7(arr7,rect)
    { BufferAccess2dIter7C<Data1T,Data2T,Data3T,Data4T,Data5T,Data6T,Data7T>::First(dat1,dat1.Range2(),
										    dat2,dat2.Range2(),
										    dat3,dat3.Range2(),
										    dat4,dat4.Range2(),
										    dat5,dat5.Range2(),
    ...
    Array2dIter7C(const Array2dC<Data1T> &arr1,const IndexRange2dC &irng1,
		  ...
		  const Array2dC<Data7T> &arr7,const IndexRange2dC &irng7)
      : dat1(arr1,irng1),
        dat2(arr2,irng2),
        dat3(arr3,irng3),
        dat4(arr4,irng4),
    ...
    inline bool First() {
      return BufferAccess2dIter7C<Data1T,Data2T,Data3T,Data4T,Data5T,Data6T,Data7T>::First(dat1,dat1.Range2(),
											   dat2,dat2.Range2(),
											   dat3,dat3.Range2(),
											   dat4,dat4.Range2(),
											   dat5,dat5.Range2(),
