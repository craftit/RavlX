...
//! lib=RavlImage
//! file="Ravl/Image/Base/FloatYPbPrBT709Value.cc"
...
namespace RavlImageN {
  ...
  RGBValueC<FloatT> FloatYPbPrBT709ValueC::FloatRGB() const {
    RGBValueC<float> ret;
    YPbPrBT709Float2RGBFloat(FloatYPbPr(),ret);
    return ret;
  }
  
  
  static TypeNameC type2(typeid(FloatYPbPrBT709ValueC),"RavlImageN::FloatYPbPrBT709ValueC");
  ...
  BinIStreamC &operator >> (BinIStreamC &in,ImageC<FloatYPbPrBT709ValueC> &img) { 
    ...
    in >> rect;
    img = ImageC<FloatYPbPrBT709ValueC>(rect);
