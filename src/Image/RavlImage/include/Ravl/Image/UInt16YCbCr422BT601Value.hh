...
namespace RavlImageN {
  ...
  {
  public:
    UInt16YCbCr422BT601ValueC()
    {}
    //: Default constructor.
    // The value is left undefined.
    
    UInt16YCbCr422BT601ValueC(UInt16T xbr,UInt16T xy)
      : YCbCr422BT601ValueC<UInt16T>(xbr,xy)
    {}
    //: Construct from components.
    
    UInt16YCbCr422BT601ValueC(const YCbCr422BT601ValueC<UInt8T> &oth) {
...
namespace RavlN {
  ...
  template<>
  struct NumericalTraitsC<RavlImageN::UInt16YCbCr422BT601ValueC> {
